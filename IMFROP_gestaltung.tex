...
Die in diesem Kapitel besprochenen Aspekte werden im Sinne des MVC als \textbf{View}\index{MVC!View} bezeichnet.\\
...
Die Datei kann natürlich auch anders als \verb|style.css| heißen, wichtig ist nur, dass die Endung \verb|.css| ist. Außerdem gilt in Bezug auf die URL dasselbe, was Sie schon im vorletzten Kapitel über relative und absolute Adressierung gelernt haben.
...
In Dokumentationen über CSS werden Sie des Öfteren auf den Begriff des \textbf{Selektor}s\index{Selektor}\index{CSS!Selektor} stoßen. Der Selektor ist in CSS schlicht der Bezeichner des Containers, den Sie formatieren wollen.\\

Damit wissen Sie jetzt ungefähr 50\% dessen, was Sie im Rahmen dieses Kurses für die Programmierung von CSS wissen müssen. Alles was Sie noch lernen müssen ist wie Sie den sogenannten \textbf{Properties}\index{Property}\index{CSS!Property} Werte zuordnen müssen, um die Gestaltung der Container festzulegen und was es mit dem \verb|.| (Punkt) und \verb|#| vor Selektoren in CSS auf sich hat.
...
Außerdem wird hier die englische Schreibweise für die Dezimaltrennung verwendet: Dort verwenden Sie kein Komma, sondern einen Punkt, um zwischen ganzen Zahlen und \glqq{}Nachkommastellen\grqq{} zu trennen.\\
...
Unter Umständen überschneidet Ihr Text jetzt die abgerundeten Ecken. Da können Sie sich mit der Property \verb|padding| behelfen. Padding legt einen Abstand vom Rand fest, den der Text haben muss.\\
